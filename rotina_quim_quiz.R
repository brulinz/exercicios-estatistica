...
caminho="C:/Users/phtos/Documents/5-Professor - UFPR/06-especialização/aula_regl/bases de dados/quimiometria"
dados=read.csv2(file=paste0(caminho,"/QUIM.csv"),header = T)
set.seed(1234)
names(dados)
str(dados)
